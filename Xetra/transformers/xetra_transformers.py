...
from datetime import datetime               # ← make sure this is here too
...
class XetraETL():
    ...
    def __init__(self, s3_bucket_src, s3_bucket_trg, meta_key, src_args, trg_args):
    ...
    def etl_report1(self):
        ...
        """
    # Extraction
        data_frame = self.extract()         # ← same indent as docstring
        # Transformation
