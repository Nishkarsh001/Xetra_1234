"""Integration tests for the XetraETL class."""
import os
import unittest
...
class IntTestXetraETLMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s3_endpoint_url = 'https://s3.amazonaws.com'
        self.s3_bucket_name_src = 'xetra-int-test1-src'
        self.s3_bucket_name_trg = 'xetra-int-test1-trg'
    ...
    def test_int_etl_report1_no_metafile(self):
        """
        integration test for etl_report1 method
        """
        # Expected results
